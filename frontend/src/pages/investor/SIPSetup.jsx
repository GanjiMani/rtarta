...
import { Repeat, CheckCircle, X, ArrowRight, Calendar, Wallet } from "lucide-react";
...
export default function SIPSetup() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      setSuccessMsg(
        `SIP setup successful! Registration ID: ${result.data?.sip_registration?.registration_id || "N/A"}`
      );
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-700 text-white shadow-lg">
        <div className="px-6 py-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold">SIP Setup</h1>
          </div>
            ...
            <div className="flex justify-end gap-4 pt-4">
              ...
              >
                {loading ? (
                  ...
                  <>
                    Review SIP Setup <ArrowRight className="w-4 h-4" />
                  </>
                )}
              </button>
            </div>
              ...
              <table className="w-full">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {activeSIPs.map((sip, index) => (
                    <tr key={sip.registration_id || index} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {sip.registration_id || "N/A"}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{sip.scheme_id || "N/A"}</td>
